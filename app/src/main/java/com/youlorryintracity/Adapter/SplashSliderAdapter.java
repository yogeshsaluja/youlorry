...
import com.youlorryintracity.Splash;
...
public class SplashSliderAdapter extends PagerAdapter {
    ...
    private Integer [] images = {R.layout.sliderone,R.layout.slidertwo,R.layout.sliderthree};

    public SplashSliderAdapter(Splash splash) {
        this.context=splash;
    }
